    ...
    <div class="container rounded bg-white mt-5 mb-5">
        <div class="row">
            ...
            <div class="col-md-5 border-left">
                <form aciton="<%=request.getContextPath()%>/MyProfile" method="POST">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="fullname" class="form-control" placeholder="<%=account.getFullname()%>" value="<%=account.getFullname()%>">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="date" name="dob" class="form-control" placeholder="<%=account.getDOB()%>" value="<%=account.getDOB()%>">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <label class="labels">Email</label>
                            <input type="email" name="email" class="form-control" placeholder="<%=account.getEmail()%>" value="<%=account.getEmail()%>">
                        </div>
                        <div class="col-md-12">
                            <label class="labels">Điện Thoại</label>
                            <input type="text" name="phone" class="form-control" placeholder="<%=account.getPhone()%>" value="<%=account.getPhone()%>">
                        </div>
                        <div class="col-md-12">
                            <label class="labels">Địa Chỉ</label>
                            <input type="text" name="address" class="form-control" placeholder="<%=account.getAddress()%>" value="<%=account.getAddress()%>">
                        </div>
                    </div>
