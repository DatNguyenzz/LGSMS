                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody style="text-align: right;">
                                            ...
                                            <tr>
                                                ...
                                                <td><%=formatNumber.formatDouble( (revenuesByQuarterNow.getRevenue()-revenuesByQuarterBefore.getRevenue())/revenuesByQuarterBefore.getRevenue()*100)%>%</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=formatNumber.formatDouble((costByQuarterNow.getCost()-costByQuarterBefore.getCost())/costByQuarterBefore.getCost()*100)%>%</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><%=formatNumber.formatDouble(((revenuesByQuarterNow.getRevenue()-costByQuarterNow.getCost())-(revenuesByQuarterBefore.getRevenue()-costByQuarterBefore.getCost()))/(revenuesByQuarterBefore.getRevenue()-costByQuarterBefore.getCost())*100) %>%</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
