 ...
 * @author admin
 */
public class OrderDetailOfCusFilter implements Filter {
    ...
    public OrderDetailOfCusFilter() {
    }

    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("OrderDetailOfCusFilter:DoBeforeProcessing");
        }
        ...
        if (acc != null) {
            if (acc.getAccountID() != orderService.getOrderByID(orderID).getCustomerID()) {
                request.getRequestDispatcher("Customer_LGSMS/view/404_not_found.jsp").forward(request, response);
            }
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("OrderDetailOfCusFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("OrderDetailOfCusFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("OrderDetailOfCusFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("OrderDetailOfCusFilter()");
        }
        StringBuffer sb = new StringBuffer("OrderDetailOfCusFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("OrderDetailOfCusFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("OrderDetailOfCusFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("OrderDetailOfCusFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("OrderDetailOfCusFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("OrderDetailOfCusFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
